...
@Configuration
@EnableMongoRepositories(basePackages = "de.springframework.keycloak.vets.repository")
public class MongoConfiguration extends BaseMongoConfiguration {

    private static final String CHANGESETS = "de.springframework.keycloak.vets.changesets";
